...
struct zzmoove_profile zzmoove_profiles[] = {
	{
...
#endif /* ENABLE_SNAP_THERMAL_SUPPORT */
		1036800,	// scaling_block_freq (all valid system frequencies)
		...
		1036800,	// inputboost_punch_freq (0=disable, range from 0 to freq->max in khz)
