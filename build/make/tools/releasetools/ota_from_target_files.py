...
""" % bcb_dev)
  ...
  system_progress = 0.6
  script.Print (" _    ___  ___  ___  ___ ");
  script.Print ("| |  | . |/ __>| . |/ __>");
  ...
  script.LososCustomScript('run_program("/sbin/busybox","rm","-r","/system/app/Home");')
  script.LososCustomScript('run_program("/sbin/busybox","rm","-r","/system/app/Email");')
